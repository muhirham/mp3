...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @if(session('success'))
        <div id="company-success-message"
             data-message="{{ session('success') }}"></div>
    @endif

    @if(session('error'))
        <div id="company-error-message"
             data-message="{{ session('error') }}"></div>
    @endif

    @if($errors->any())
        <div id="company-error-messages"
                ...
                <table class="table table-sm table-striped mb-0 align-middle" id="companies-table">
                    ...
                    <tbody>
                        @forelse($companies as $company)
                            <tr>
                                <td>
                                    @if($company->logo_small_path ?? $company->logo_path)
                                        <img src="{{ asset('storage/'.($company->logo_small_path ?: $company->logo_path)) }}"
                                             alt="logo"
                                             style="height: 32px;">
                                    @endif
                                </td>
                            ...
                            {{-- Modal Edit Company --}}
                            <div class="modal fade" id="edit-company-{{ $company->id }}" tabindex="-1" aria-hidden="true">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="mb-2 form-check">
                                                            ...
                                                            <label class="form-check-label" for="company-default-{{ $company->id }}">
                                                                Set sebagai default
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="mb-3 form-check">
                                                            ...
                                                            <label class="form-check-label" for="company-active-{{ $company->id }}">
                                                                Aktif
                                                            </label>
                                                        </div>
                                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="short_name" class="form-control" value="{{ old('short_name') }}" placeholder="NTT, MAND, dll">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Kode</label>
                                <input type="text" name="code" class="form-control" value="{{ old('code') }}" placeholder="NTT01, HO, dll">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2 form-check">
                                <input type="checkbox" name="is_default" value="1" class="form-check-input" id="company-default-create">
                                <label class="form-check-label" for="company-default-create">Set sebagai default</label>
                            </div>

                            <div class="mb-3 form-check">
                                <input type="checkbox" name="is_active" value="1" class="form-check-input" id="company-active-create" checked>
