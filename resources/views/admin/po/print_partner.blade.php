...
<body>
    ...
    @php
        ...
        $partnerAddr =
            $company?->address ??
            'Komplek Golden Plaza Blok C17, Jl. RS Fatmawati No. 15, Jakarta Selatan, DKI Jakarta';
    ...
    <table class="{{ $signTableClass }}">
        ...
        <tr>
            ...
            <td>
                <div style="height:50px; margin-top:5px; margin-bottom:5px;">
                    @if ($creator?->signature_url)
                        <img src="{{ $creator->signature_url }}" style="height:45px;">
                    @endif
            ...
            <td>
                <div style="height:50px; margin-top:5px; margin-bottom:5px;">
                    @if ($needsCeo)
                        @if ($procUser?->signature_url)
                            <img src="{{ $procUser->signature_url }}" style="height:45px;">
                        @endif
                    @else
                        @php $approver = $procUser ?: $ceoUser; @endphp
                        @if ($approver?->signature_url)
                            <img src="{{ $approver->signature_url }}" style="height:45px;">
                        @endif
                    @endif
                </div>
            </td>
            ...
            @if ($needsCeo)
                <td>
                    <div style="height:50px; margin-top:5px; margin-bottom:5px;">
                        @if ($ceoUser?->signature_url)
                            <img src="{{ $ceoUser->signature_url }}" style="height:45px;">
                        @endif
                    </div>
                </td>
            @endif
