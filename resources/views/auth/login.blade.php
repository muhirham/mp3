                        ...
                        <div class="col-md-5 auth-hero d-flex flex-column justify-content-start p-4">
                            <div>
                                ...
                                <img src="{{ asset('sneat/assets/img/illustrations/man-with-laptop-light.png') }}"
                                    alt="Sales dashboard illustration" class="img-fluid auth-illustration mt-2"
                                    onerror="this.style.display='none';">
                            </div>

                            <p class="small-muted mb-0 mt-4">
                                Tip: Kamu bisa login pakai <strong>Username</strong> yang sudah
                                terdaftar.
                            </p>
                        ...
                        <div class="col-md-7">
                            <div class="card-body p-4 p-md-5">
                                ...
                                <p class="text-muted mb-4">
                                    Masuk menggunakan <strong>Username</strong> dan password akunmu.
                                </p>
                                <form method="POST" action="{{ route('login.attempt') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="login" name="login" type="text"
                                            ...
                                            value="{{ old('login') }}" required autofocus placeholder="contoh: john">
                                        @error('login')
